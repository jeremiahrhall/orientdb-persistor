...
- Documents are either Vertices or Edges, the building blocks of a graph
- Documents are (optionally) organized as classes in an object-oriented fashion (sub-classes are considered members of super-classes)

For a more in-depth explanation of the differences, see this OrientDB Wiki article:

[https://github.com/orientechnologies/orientdb/wiki/Tutorial%3A-Document-and-graph-model](https://github.com/orientechnologies/orientdb/wiki/Tutorial%3A-Document-and-graph-model)

####To use this module you must have an OrientDB server running on your network.

This is a multi-threaded worker module.

## Dependencies

This module requires a OrientDB server to be available on the network.
...
The orientdb-persistor module takes the following configuration:
